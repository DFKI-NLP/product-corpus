...
Run tap/.../DeduplicationFilterJob (filters by URI, ID and TextProfileSignature). Reduces number of documents to 174.
Run de.dfki.lt.spree.flink.batch.DocumentTrainDevTestSplitJob with 0.8, 0.1, 0.1 to create dev set
